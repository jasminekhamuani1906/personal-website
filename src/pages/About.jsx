...
const About = () => {
  const funFacts = [
    { label: 'Favorite Cuisine', value: 'Italian' },
    { label: 'Hobbies', value: 'Hiking, Dancing, Cooking' },
    { label: 'Based In', value: 'Berkeley, CA' },
    { label: 'Fun Fact', value: 'I have watched every movie in the Fast & Furious series three times' },
  ];
